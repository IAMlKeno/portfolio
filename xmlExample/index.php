...
<html>
    ...
    <div id="container">
        <?php
            ...
            echo '    <span class="location">Forecast for: '. $location->city. ', '. $location->province.
            ...
            // using this loop, is will iterate through each day
            foreach($daily->day as $day)
            {
                ...
                echo '
                        <td>'.
                            $day->date.'
                            <br /><img src="images/'.$day->condition.'.jpg" />
                            <br />
                            High: '.$day->high.'&deg;
                            <br/>
                            Low: '.$day->low.'&deg;
