...
if(isset($_POST['veggieName']) && isset($_POST['price'])){
    ...
    if(is_numeric($_POST['price'])){
        ...
        echo "<p>You did not enter a number! Please <a href='javascript:window.history.go(-1)'>GO BACK</a> and correct this!</p>
                </div></body></html>";
        exit;
    }
} else {
    echo "<p>You missed some information on your form! Please <a href='javascript:window.history.go(-1)'>GO BACK</a> and
        correct this!</p></div></body></html>";
    exit;
}
