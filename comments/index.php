...
if(isset($_POST['addComment']) == true)
{
    if (isset($_POST['comment']) && !empty($_POST['comment']))
    {
        if(isset($_POST['title']) && !empty($_POST['title']))
        {
            ...
            // Found that by using the header redirect, it solves the problem of the form being submitted over and over
            // when the page is reloaded.
            // Research showed that redirects are a comment way to counteract repetitious form submission
...
?>
    ...
    {
    echo '<div id="commentDiv" class="mdl-cell--12-col-desktop mdl-cell--4-col-phone mdl-cell--6-col-tablet">
        <table id="comments">
            <thead><td>User</td><td>Comment</td></thead>';
    ...
    echo "<hr />";
    // if the user is logged in then display the html form that will accept their comment and add to database
    if($_SESSION['loggedIn'])
    {
    echo '
            ...
            <div class="mdl-card-wide">
                ...
                <div class="mdl-card__actions mdl-card--border">
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        ...
                        <label class="mdl-textfield__label loginText" for="titile">Title:</label>
                    </div>
                </div>
            </div>
            <br />
    ...
    <div class="mdl-card mdl-small-card center-card">
        <form action="index.php" method="post">
            ...
            <div class="mdl-card__actions mdl-card--border">
                <input type="submit" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--colored
                    mdl-button--raised" name="logout" value="Click here to logout" />
            </div>
        </form>
    </div>';
    }
